...
function modifyTime(visitTime) {
    let temp = visitTime.toString();
...
function fetchNeedVisit(startDate, endDate) {
    let url = server + 'visit/search';
...
export const visitservice = {
    fetchVisitList, modifyTime, fetchNeedVisit, exportFile
};
